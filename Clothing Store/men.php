    ...
    <body>
        ...
        <main class="main">
            ...
            <section class="shop section container">
                ...
                <h3 class="breadcrumb__subtitle">Home > <span> Men's Wear</span></h3>

                <div class="category">
                    <div class="cat men">
                        <img src="images/pants&leggins.webp" alt="">
                        <button class="btn-css"><a href="">Pants & Leggins</a></button>
                    </div>
                    <div class="cat women">
                        <img src="images/shorts.webp" alt="">
                        <button class="btn-css"><a href="">Shorts</a></button>

                    </div>
                    <div class="cat kids">
                        <img src="images/tops&T_shirt.webp" alt="">
                    <button class="btn-css"> <a href="" class="">Tops & T_shirt</a></button> 

                    </div>
                </div>

                <h3 class="Shop__subtitle">~ Men's Wear ~</h3>
                <div class="shop__items grid">
                        ...
                        <?php
                            if($fetch_products['category'] == "Men" ){
                        ?>
