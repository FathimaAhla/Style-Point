    ...
    <body>
        ...
        <main class="main">
            ...
            <section class="shop section container">
                ...
                <h3 class="breadcrumb__subtitle">Home > <span> Kids's Wear</span></h3>

                <div class="category">
                    <div class="cat men">
                        <img src="images/Kids_2.jpg" alt="">
                        <button class="btn-css"><a href="">Baby</a></button>
                    </div>
                    <div class="cat women">
                        <img src="images/Kids_1.webp" alt="">
                        <button class="btn-css"><a href="">Young boys</a></button>

                    </div>
                    <div class="cat kids">
                        <img src="images/Kids-1.webp" alt="">
                    <button class="btn-css"> <a href="" class="">Young Girl</a></button> 

                    </div>
                </div>

                <h3 class="Shop__subtitle">~ Kid's Wear ~</h3>
                <div class="shop__items grid">
                        ...
                        <?php
                            if($fetch_products['category'] == "Kids" ){
                        ?>
