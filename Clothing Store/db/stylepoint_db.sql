...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 02, 2023 at 06:52 PM
...
(11, 'Fathima Eshqa', 'ahla@gmail.com', 763425678, 'What is your preferred clothing style or fashion preference?', '2023-06-30', '', '0000-00-00');
...
(33, 1, 'Ms. , Fathima', 'ahla', 772466033, 'ahla@gmail.com', '133 A/2, Kahatowita, Veyangoda, 11144', 'Zara', 'Red', 'Polyester', 'M', 'Floral Printed Mini Dress:  (2000 x 1) Floral Embroidery Kurta Top:  (1600 x 1)Multicolor Floral Pri', 3780, '2023-07-02', 'Floral_Printed_Midi_1.webp', '', '\r\nWarning:  Undefined variable $fetch_orders in C:\\xampp\\htdocs\\Clothing Store\\checkout.php on line '),
(37, 1, 'Ms. , Fathima', 'ahla', 772466033, 'ahla@gmail.com', '133 A/2, Kahatowita, Veyangoda, 11144', 'MOOSE', 'Red', 'Moose', 'M', 'Premium Casual Stretch Chino Pant :  (2500 x 1)', 2525, '2023-07-02', 'Casual_Stretch_Chino_Pant_1.jpg', '', '\r\nWarning:  Undefined variable $fetch_orders in C:\\xampp\\htdocs\\Clothing Store\\checkout.php on line ');
...
(8, 8, 1, 'ahla', 'user-4.jpg', 'I recently purchased th Floral Print Maxi Dress from this clothing store, and I couldn&#39;t be happier with my purchase. The dress is absolutely stunning and exceeded my expectations in every way.', 3, '2023-06-30'),
(9, 8, 1, 'ahla', 'user-4.jpg', 'Thank you for fast shipping from only 3 days', 4, '2023-06-30'),
(10, 16, 1, 'ahla', 'user-4.jpg', 'Very happy with the purchases I&#39;ve made here. The shirts I&#39;ve ordered are exactly what I needed. I really like the look and feel of the NextLevel brand and the prices are hard to beat. The website is very easy to navigate. Shipping was fast and without complications. I would highly recommend.', 5, '2023-06-30'),
(11, 16, 3, 'Umar', 'user-2.png', 'Great online shopping experience. Ordered t-shirts to make as presents for new grandparents. The shirts were amazing. Great quality and colors. The fit was true to size and shipping was super fast. Online ordering was a breeze. I will be using this company in the future for my business.', 4, '2023-06-30');
...
(3, 'Ms. , Mohammed', 'Umar', 'umar@gmail.com', 781234567, '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', '123, Hemmathagama, Mawanella, 11234', 'user-2.png');
...
--
ALTER TABLE `messages`
  MODIFY `msg_ID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `orders`
--
ALTER TABLE `orders`
  MODIFY `orders_ID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `reviews`
  MODIFY `review_ID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `size`
--
ALTER TABLE `size`
  MODIFY `size_ID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
