...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 25, 2023 at 08:10 PM
...
INSERT INTO `color` (`color_ID`, `pro_ID`, `color`) VALUES
(1, 0, 'Red'),
(2, 0, 'Blue'),
(3, 0, 'Greeen'),
(4, 0, 'Black');
...
INSERT INTO `orders` (`orders_ID`, `user_id`, `first_Name`, `last_Name`, `number`, `email`, `address`, `color`, `size`, `total_products`, `total_price`, `placed_On`, `image`, `payment_Status`, `pay_Method`) VALUES
...
--
ALTER TABLE `size`
  MODIFY `size_ID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
