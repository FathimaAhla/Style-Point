...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 27, 2023 at 08:34 PM
...
(11, 1, 'Mrs. , Fathima', 'ahla', 772466033, 'ahla@gmail.com', '133 A/2, Kahatowita, Veyangoda, 11144', '', 'Red', '', 'M', 'Multicolor Floral Printed Midi Dress (2000 x 3) <br> Floral Printed Mini Dress (2000 x 1) <br> Print', 14700, '2023-06-27', '', 'completed', ''),
(12, 1, 'Mrs. , Fathima', 'ahla', 772466033, 'ahla@gmail.com', '133 A/2, Kahatowita, Veyangoda, 11144', '', 'Red', '', 'M', 'Multicolor Floral Printed Midi Dress (2000 x 3) <br> Floral Printed Mini Dress (2000 x 1) <br> Print', 14700, '2023-06-27', '', '', ''),
(13, 1, 'Mrs. , Fathima', 'ahla', 772466033, 'ahla@gmail.com', '133 A/2, Kahatowita, Veyangoda, 11144', '', 'Red', '', 'M', 'Multicolor Floral Printed Midi Dress (2000 x 3) <br> Floral Printed Mini Dress (2000 x 1) <br> Print', 14700, '2023-06-27', 'Print_Smocked_Sleeve_1.webp', '', ''),
(14, 1, 'Mrs. , Fathima', 'ahla', 772466033, 'ahla@gmail.com', '133 A/2, Kahatowita, Veyangoda, 11144', '', 'Red', '', 'M', 'Multicolor Floral Printed Midi Dress (2000 x 3) <br> Floral Printed Mini Dress (2000 x 1) <br> Print', 14700, '2023-06-27', 'Print_Smocked_Sleeve_1.webp', '', '');
...
--
ALTER TABLE `messages`
  MODIFY `msg_ID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `orders`
--
ALTER TABLE `orders`
  MODIFY `orders_ID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `size`
  MODIFY `size_ID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
